...
header = Label(root, text='IDEAL BODY MASS INDEX CALCULATOR', bg='#EED3CB', fg='black')
header.place(x=220, y=20)

frame = Frame(root, width=500, height=200, relief='raised', bg='#EED3CB')
frame.place(relx=0.15, rely=0.1)

weight = Label(frame, text="Weight(kg):", bg='#EED3CB', fg='black')
weight.place(relx=0.1, rely=0.1)
weight_entry = Entry(frame)
weight_entry.place(relx=0.4, rely=0.1)

height = Label(frame, text="Height(cm):", bg='#EED3CB', fg='black')
height.place(relx=0.1, rely=0.3)
height_entry = Entry(frame)
height_entry.place(relx=0.4, rely=0.3)

gender = Label(frame, text="Gender:", bg='#EED3CB', fg='black')
gender.place(rely=0.53, relx=0.1)

age = Label(frame, text="Age:", bg='#EED3CB', fg='black')
...
category_head = Label(root, text="Category:", bg='#EED3CB', fg='black')
category = Label(root, width=20, bg='#EED3CB', fg='black')
